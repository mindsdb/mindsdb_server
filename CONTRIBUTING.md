# Contributing to Mindsdb Server

We love to receive contributions from the community and hear your opinions! We want to make contributing to Mindsdb Server as easily as it can be.
...
* Test Mindsdb Server endpoints

# Code contributions
In general, we follow the "fork-and-pull" Git workflow.

1. Fork the Mindsdb server repository
...
We use GitHub issues to track bugs and features. Report them by opening a [new issue](https://github.com/mindsdb/mindsdb_server/issues/new/choose) and fill out all of the required inputs.
